...
public class LargeBackpackContainerMenu extends AbstractContainerMenu {
    private final Container inventory;
    private final Inventory playerInventory;
    private final int rows = 9;
    private final int cols = 13;

    public LargeBackpackContainerMenu(int syncId, Inventory playerInv, Container inv) {
        super(SmacksUtil.GENERIC_13X9.get(), syncId);
    ...
    public static LargeBackpackContainerMenu createGeneric13x9(int syncId, Inventory playerInventory, FriendlyByteBuf buf) {
        return new LargeBackpackContainerMenu(syncId, playerInventory, ImplementedInventory.ofSize(13 * 9));
    }
