...
public class LargeBackpackScreen extends AbstractContainerScreen<LargeBackpackContainerMenu> {
    ...
    public LargeBackpackScreen(LargeBackpackContainerMenu handler, Inventory inventory, Component title) {
