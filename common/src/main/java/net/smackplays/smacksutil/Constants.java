...
public class Constants {
    ...
    public static final String C_BACKPACK_SCREEN = "backpack_screen";
    public static final String C_BACKPACK_SCREEN_LOCATION = "textures/gui/container/backpack_screen.png";
    public static final String C_LARGE_BACKPACK_SCREEN = "large_backpack_screen";
    public static final String C_LARGE_BACKPACK_SCREEN_LOCATION = "textures/gui/container/large_backpack_screen.png";
    public static final String C_ENCHANTING_TOOL_SCREEN = "enchanting_tool_screen";
    public static final String C_ENCHANTING_TOOL_SCREEN_LOCATION = "textures/gui/container/enchanting_tool_screen.png";
    public static final String C_ENCHANTING_SLOT_HIGHLIGHTED_SPRITE_LOCATION = "textures/gui/container/enchanting_slot_highlighted.png";
    public static final String C_ENCHANTING_SLOT_SPRITE_LOCATION = "textures/gui/container/enchanting_slot.png";
    public static final String C_ENCHANTING_SLOT_DISABLED_SPRITE_LOCATION = "textures/gui/container/enchanting_slot_disabled.png";
